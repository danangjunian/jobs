                                ...
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        <div class="u-s-m-b-15">
                                            <h1 class="gl-h1">SUDAH MEMILIKI AKUN?</h1>
                                            <a class="l-f-o__create-link btn--e-transparent-brand-b-2" href="signin"><u> MASUK SEKARANG</u></a></div>
                                        ...
                                        <form class="l-f-o__form">
                                            ...
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <span class="gl-label">TANGGAL LAHIR</span>
                                                    <div class="gl-dob">
                                                            <input class="select-box select-box--primary-style" type="date" id="reg-email" placeholder="Enter E-mail">
                                                    </div>
