        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/tanggal">
                    ...
                    <span>Search dari Tanggal</span></a>
            </li>
        
            <li class="nav-item">
                <a class="nav-link" href="/tambah/data">
                    <i class="fas fa-folder-plus fa-chart-area"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{Auth::guard('adminlogin')->user()->nama_admin}}</span>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Lawang 2020</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
